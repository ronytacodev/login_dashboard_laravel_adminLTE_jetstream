...
Build an Login & Dashboard application template with LARAVEL 10 & AdminLTE.
...
## The Commands 
* to create project -->  laravel new laravel_dashboard_jetstream --jet
* npm install && npm run dev
* php artisan migrate
* php artisan serve  --> http://127.0.0.1:8000/ ( paste in  browser)
* to install adminLTE: 
    * 1.composer require jeroennoten/laravel-adminlte
    * 2.php artisan adminlte:install 

Note Credentials Test to LOGIN:
